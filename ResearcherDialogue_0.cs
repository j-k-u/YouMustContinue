...
public class ResearcherDialogue : MonoBehaviour 
{
    ...
    IEnumerator InterruptCoroutine()
    {
        if (isTalking==false)
        {
            ...
            yield return new WaitForSeconds(0.5f);
            yield return new WaitWhile(() => (!Input.GetKeyDown("0") && !Input.GetKeyDown("1")) && !Input.GetKeyDown("[0]") && !Input.GetKeyDown("[1]"));
            var choice = Choose();
            yield return new WaitForSeconds(0.5f);
            ChoiceBubbles.SetActive(false);
    ...
    IEnumerator Scene0Coroutine()
    {
        if (isTalking==false)
        {
            ...
            yield return new WaitForSeconds(0.5f);
            yield return new WaitWhile(() => (!Input.GetKeyDown("0") && !Input.GetKeyDown("1")) && !Input.GetKeyDown("[0]") && !Input.GetKeyDown("[1]") && !Input.GetKeyDown("8") && !Input.GetKeyDown("[8]"));
            var choice = Choose();
            yield return new WaitForSeconds(0.5f);
            ChoiceBubbles.SetActive(false);
